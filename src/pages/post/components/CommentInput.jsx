        ...
        <div className="my-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 mt-4">
                ...
                <div className="text-right">
                    <input type="text" onInput={authorHandler} placeholder="Your display name" className="mr-4 rounded-lg px-6 py-4 sm:px-4 sm:py-3 w-full sm:w-72 bg-gray-700 focus:outline-none shadow-lg font-light" />
                    <button onClick={submitHandler} disabled={!content} className="bg-sky-600 hover:bg-sky-700 active:bg-sky-800 disabled:bg-slate-400 disabled:opacity-75 disabled:cursor-not-allowed duration-100 px-4 py-3 mt-4 sm:mt-0 rounded-lg shadow-lg">
                        Comment
                    </button>
                </div>
            </div>
